...
def beat_track(y=None, sr=48000, onset_envelope=None, hop_length=512,
               start_bpm=133.0, tightness=100, trim=True, bpm=None,
               units='frames'):
...
@cache(level=30)
def tempo(y=None, sr=48000, onset_envelope=None, hop_length=512, start_bpm=133,
...
def plp(y=None, sr=48000, onset_envelope=None, hop_length=512,
