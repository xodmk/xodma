...
# *****************************************************************************
#
# __::((xodmaSpectralCQT.py))::__
#
# XODMK Audio Tools - Constant Q Transform
#
#       
#
# *****************************************************************************
...
@cache(level=20)
def cqt(y, sr=48000, hop_length=512, fmin=None, n_bins=84,
...
@cache(level=20)
def hybrid_cqt(y, sr=48000, hop_length=512, fmin=None, n_bins=84,
               bins_per_octave=12, tuning=0.0, filter_scale=1,
