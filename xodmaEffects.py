...
# __::((xodmaEffects.py))::__
#
# ___::((XODMK Programming Industries))::___
# ___::((XODMK:CGBW:BarutanBreaks:djoto:2020))::___
#
#
# XODMK Audio Tools - Audio Effects
#
#   __Harmonic-percussive source separation__
#
#  - hpss: harmonic percussive source separation (HPSS)
#  - harmonic: Extract harmonic elements from audio src
#  - percussive: Extract percussive elements from audio src
#
#
#   __Time and frequency effects__
#
#  - time_stretch: 
#  - pitch_shift:
#
#
#   __Miscellaneous effects__
#
#  - remix:
#  - trim:
#  - split:
...
from xodmaSpectralUtil import frames_to_samples
from xodmaAudioTools import resample, to_mono, valid_audio
from xodmaSpectralTools import power_to_db, stft, istft, phase_vocoder
from xodmaDecompose import hpss
from xodmaSpectralFeature import rmse
...
def pitch_shift(y, sr, n_steps, bins_per_octave=12, res_type='kaiser_best',
    ...
    y_shift = resample(time_stretch(y, rate, **kwargs), float(sr)/rate, sr,
                            res_type=res_type)
