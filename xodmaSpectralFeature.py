...
from xodmaSpectralTools import dct, mel, chroma, power_to_db, cq_to_chroma, mag_spectrogram
from xodmaSpectralCQT import cqt, hybrid_cqt
...
def zero_crossing_rate(y, frame_length=2048, hop_length=512, center=True,
    ...
    y_framed = frame(y, frame_length, hop_length)
...
# -- Chroma --#
def chroma_stft(y=None, sr=48000, S=None, norm=np.inf, n_fft=2048,
...
def chroma_cens(y=None, sr=48000, C=None, hop_length=512, fmin=None,
...
def mfcc(y=None, sr=48000, S=None, n_mfcc=20, **kwargs):
...
def melspectrogram(y=None, sr=48000, S=None, n_fft=2048, hop_length=512,
                   power=2.0, **kwargs):
...
# ***FIXIT - import problem cross-import with onset imports 
## -- Rhythmic features -- #
#def tempogram(y=None, sr=48000, onset_envelope=None, hop_length=512,
...
#    odf_frame = frame(onset_envelope,
...
#    return normalize(autocorrelate(odf_frame * ac_window[:, np.newaxis],
#                                        axis=0), norm=norm, axis=0)