...
class FJSFormatter(mplticker.Formatter):
    ...
    def __init__(
        ...
        *,
        ...
        self.frequencies_ = interval_frequencies(
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            self.intervals_ = interval_frequencies(
...
def __scale_axes(axes, ax_type, which):
    ...
    if ax_type == "mel":
        ...
        mode = "symlog"
        kwargs[base] = 2
        kwargs[thresh] = float(note_to_hz("C2"))
        kwargs[scale] = 0.5
...
def __decorate_axis(
    ...
    if ax_type == "tonnetz":
        ...
        if unison is None:
            unison = hz_to_note(fmin, octave=False, cents=False)
        ...
        if isinstance(intervals, str) and bins_per_octave > 7:
            ...
            tick_intervals = interval_frequencies(
                7,
                fmin=1,
                intervals=intervals,
                bins_per_octave=bins_per_octave,
            ...
            all_intervals = interval_frequencies(
                bins_per_octave,
                fmin=1,
                intervals=intervals,
                bins_per_octave=bins_per_octave,
            ...
            degrees = match_events(tick_intervals, all_intervals)
        else:
